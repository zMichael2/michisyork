...
app.get("/michis", (req, res) => {
  res.status(200).json([
    {
      id: 0,
      name: "Leo",
      gender: "male",
      imageFileName: "https://i.postimg.cc/1X2RNX0V/leo.jpg",
      description:
    ...
    },
    {
      ...
      name: "Jasmine",
      gender: "female",
      imageFileName: "https://i.postimg.cc/hjCtcpfr/jasmine.jpg",
      description:
    ...
    },
    {
      ...
      name: "MARTHA",
      gender: "female",
      imageFileName: "https://i.postimg.cc/xj41Zprj/martha.jpg",
      description:
    ...
    },
    {
      ...
      name: "Toby",
      gender: "male",
      imageFileName: "https://i.postimg.cc/W1Mph2dt/toby.jpg",
      description:
    ...
    },
    {
      ...
      name: "Vienna",
      gender: "female",
      imageFileName: "https://i.postimg.cc/7LwHzpz9/vienna.jpg",
      description:
    ...
    },
    {
      ...
      name: "Joey",
      gender: "male",
      imageFileName: "https://i.postimg.cc/cCr4Hw3N/joey.jpg",
      description:
    ...
    },
    {
      ...
      name: "Mary",
      gender: "female",
      imageFileName: "https://i.postimg.cc/NjhfsyfW/mary.jpg",
      description:
